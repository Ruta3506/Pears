    ...
    <div class="grid-100">
        ...
        <div class="grid-100">
          <div class="total-points-container expanded">
			...
			<?php
				$a=$row['userEmail'];
			    $b_id=$row['userID'];
			    $con = mysqli_connect("localhost","admin","5e67a505e1cbbfcfa37eca11b5f270b6a022bd32376c0165");
	  ...
	  <div class="grid-100">
       <div class="disclaimer">
        ...
        <p>Points are earned whenever you take an important action on Treehouse.Learn more about when and how points are earned.</p>
       </div>
      </div>
     </div>
    </div>
