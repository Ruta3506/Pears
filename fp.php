            ...
            <td align='center' style='border-collapse:collapse;padding-left:7%;padding-right:7%;padding-top:3%;vertical-align:top' valign='top'>
             <table border='0' cellpadding='0' cellspacing='0'>
              <tbody>
			   ...
			   <a style='color:#3f8abf;font-weight:bold;text-decoration:none' href='http://165.227.234.247/reset.php?id=$id&code=$code'>visit this link</a>.
               </h2>
              </td>
     ...
     <td align='center' style='border-collapse:collapse;padding-bottom:3%;padding-left:7%;padding-right:7%;vertical-align:top' valign='top'>
      <table border='0' cellpadding='0' cellspacing='0'>
       <tbody>
		...
		<a href='http://165.227.234.247/resetpass.php?id=$id&code=$code' target='_blank' rel='noreferrer'>http://165.227.234.247/resetpass.php?id=$id&code=$code</a>
    ...
    <div class="contained">
	 ...
	 <div class="grid-100">
        <div class="disclaimer" style="margin-top: 30px">
          ...
          <p>If you don't receive an email from us within a few minutes, check your spam filter as sometimes they end up in there. The email will be from <strong>help@teamtreehouse.com</strong>.</p>
        </div>
      </div>
